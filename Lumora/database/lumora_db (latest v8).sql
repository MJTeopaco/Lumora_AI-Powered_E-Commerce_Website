...
(199, 3, 'ADDED', 6, 1, '2025-12-03 13:23:46'),
(200, 3, 'CLEARED', NULL, NULL, '2025-12-03 13:24:03'),
(201, 3, 'CHECKED_OUT', NULL, NULL, '2025-12-03 13:24:03'),
(202, 3, 'ADDED', 6, 1, '2025-12-03 18:31:19'),
(203, 3, 'CLEARED', NULL, NULL, '2025-12-03 18:31:39'),
(204, 3, 'CHECKED_OUT', NULL, NULL, '2025-12-03 18:31:39');
...
INSERT INTO `notifications` (`notification_id`, `user_id`, `title`, `message`, `type`, `reference_id`, `metadata`, `is_read`, `read_at`, `created_at`, `updated_at`) VALUES
(31, 3, 'New Review Received', 'Someone rated \"Onitsu\" ⭐⭐⭐⭐ (4/5)', 'review_new', 1, '{\"review_id\":1,\"product_name\":\"Onitsu\",\"rating\":4}', 0, NULL, '2025-12-04 00:28:06', '2025-12-04 00:28:06'),
(32, 3, 'Your order has been shipped', 'Order #000044 - Your order has been shipped', 'order_shipped', 44, '{\"order_id\":44,\"status\":\"SHIPPED\"}', 0, NULL, '2025-12-04 13:57:45', '2025-12-04 13:57:45'),
(33, 3, 'Your order has been delivered', 'Order #000044 - Your order has been delivered', 'order_delivered', 44, '{\"order_id\":44,\"status\":\"DELIVERED\"}', 0, NULL, '2025-12-04 13:57:55', '2025-12-04 13:57:55');
...
(43, 3, 4, 4, 'DELIVERED', 749.00, 50.00, 0, '2025-12-03 13:23:48', '2025-12-03 19:35:45'),
(44, 3, 4, 4, 'DELIVERED', 749.00, 50.00, 0, '2025-12-03 18:31:22', '2025-12-04 13:57:55');
...
(43, 43, 6, 1, 699.00, 699.00, NULL, 'PROCESSING', NULL),
(44, 44, 6, 1, 699.00, 699.00, NULL, 'PROCESSING', NULL);
...
(38, 43, 'E_WALLET', 'PayMongo', 'cs_7XRDALPwDGBaCqneqCd9s1px', 749.00, '2025-12-03 13:23:49', 'COMPLETED', NULL, '2025-12-03 13:24:01'),
(39, 44, 'E_WALLET', 'PayMongo', 'cs_9k4dZnWx4f5Ktbw5CA9tnLr9', 749.00, '2025-12-03 18:31:23', 'COMPLETED', NULL, '2025-12-03 19:41:12');
...
INSERT INTO `product_reviews` (`review_id`, `user_id`, `product_id`, `order_id`, `variant_id`, `title`, `rating`, `comment`, `helpful_count`, `is_verified_purchase`, `status`, `created_at`, `updated_at`) VALUES
(1, 3, 5, 43, 6, 'Excellent item', 4, 'the quality was good', 0, 1, 'APPROVED', '2025-12-04 00:28:06', '2025-12-04 00:28:06');

-- --------------------------------------------------------

--
-- Table structure for table `product_review_helpful`
--
...
--
-- Table structure for table `product_review_responses`
--
...
(6, 5, 'Onitsu', 'BAG-001', 699.00, 38, '0', 'Medium', 'Leather', NULL, NULL, 1, '2025-11-28 01:16:14', '2025-12-03 19:41:12'),
...
(25, 3, 'ddaf5d4e6495c10e9a18e96cd0350ac3', '3eef00c9827a494da908b4eb90caae43ae0e6f26ce125dfabe602dbd1e91a042', '2026-01-03 06:55:05');
...
ALTER TABLE `product_reviews`
  ...
  ADD KEY `idx_verified` (`is_verified_purchase`);

--
-- Indexes for table `product_review_helpful`
--
ALTER TABLE `product_review_helpful`
  ADD PRIMARY KEY (`helpful_id`),
  ADD UNIQUE KEY `unique_user_review_vote` (`review_id`,`user_id`),
  ADD KEY `fk_helpful_review` (`review_id`),
...
ALTER TABLE `product_review_images`
  ...
  ADD KEY `fk_review_image` (`review_id`);

--
-- Indexes for table `product_review_responses`
--
ALTER TABLE `product_review_responses`
  ADD PRIMARY KEY (`response_id`),
  ADD UNIQUE KEY `unique_review_response` (`review_id`),
  ADD KEY `fk_response_review` (`review_id`),
  ADD KEY `fk_response_shop` (`shop_id`);
...
--
ALTER TABLE `cart_history`
  MODIFY `history_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=205;
...
--
-- AUTO_INCREMENT for table `product_review_helpful`
--
ALTER TABLE `product_review_helpful`
...
--
-- AUTO_INCREMENT for table `product_review_responses`
--
ALTER TABLE `product_review_responses`
...
ALTER TABLE `product_reviews`
  ...
  ADD CONSTRAINT `fk_review_variant` FOREIGN KEY (`variant_id`) REFERENCES `product_variants` (`variant_id`) ON DELETE SET NULL;

--
-- Constraints for table `product_review_helpful`
--
ALTER TABLE `product_review_helpful`
  ADD CONSTRAINT `fk_helpful_review` FOREIGN KEY (`review_id`) REFERENCES `product_reviews` (`review_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_helpful_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `product_review_images`
--
ALTER TABLE `product_review_images`
  ADD CONSTRAINT `fk_review_image` FOREIGN KEY (`review_id`) REFERENCES `product_reviews` (`review_id`) ON DELETE CASCADE;

--
-- Constraints for table `product_review_responses`
--
ALTER TABLE `product_review_responses`
  ADD CONSTRAINT `fk_response_review` FOREIGN KEY (`review_id`) REFERENCES `product_reviews` (`review_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_response_shop` FOREIGN KEY (`shop_id`) REFERENCES `shops` (`shop_id`) ON DELETE CASCADE;
