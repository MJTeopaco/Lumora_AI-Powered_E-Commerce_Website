...
// This will serve as your main HTML structure, surrounding $content
...
<head>
    ...
    <body>
        ...
        <?php // include $partialsPath . 'success.popup.php'; ?>


        <header class="header">
            <?php 
            // NOTE: The partial needs access to $isLoggedIn, $username, $userProfile, $isSeller, etc.
