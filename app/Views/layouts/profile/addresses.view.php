                        ...
                        <div class="address-card <?= $address['is_default'] ? 'default' : '' ?>">
                            <div class="address-header">
                                ...
                                <div class="address-actions">
                                    <button class="icon-btn" onclick="window.location.href='/profile/addresses/edit/'" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <form method="POST" action="/profile/addresses/delete" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this address?')">
